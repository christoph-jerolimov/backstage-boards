...
- [x] 1.1 Render the archived items in `ArchivedItemsDialog` as a BUI
      ...
      still pass.
- [x] 1.2 Move the Restore button into the Actions cell unchanged
...
- [x] 2.1 Extend `ArchivedItemsDialog.test.tsx` to assert the table
...
- [x] 3.1 Run `yarn prettier:check`, `yarn lint:all`, `yarn tsc:full`,
      and `yarn workspace @internal/plugin-boards test`; all pass.
- [x] 3.2 Open a board with archived items, open the archived-items
