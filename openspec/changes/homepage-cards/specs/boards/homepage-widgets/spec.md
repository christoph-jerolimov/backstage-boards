...
Defines the cards the boards plugin contributes to the Backstage home
page — what each shows, how a user configures a placed card, and how the
cards behave while loading, when empty, and on failure.
